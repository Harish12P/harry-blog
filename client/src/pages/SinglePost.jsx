...
const SinglePostPage = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-300 flex flex-col items-center py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl w-full bg-blue-100 p-8 shadow-lg rounded-lg">
        <div
          onClick={() => navigate(-1)}
